...
(function () {
  ...
  function injectStyle() {
    ...
    var css = [
      ...
      '.soho-net-head::before{content:"";width:16px;height:2px;background:var(--orange,#FF5E00);display:inline-block;}',
      ...
      'a.soho-net-card:hover{transform:translateY(-2px);border-color:var(--orange,#FF5E00);box-shadow:0 8px 20px rgba(255,94,0,.12);}',
      '.soho-net-card .snc-ico{font-size:26px;flex-shrink:0;line-height:1.1;}',
      '.soho-net-card .snc-body{min-width:0;}',
      '.soho-net-card .snc-site{font-family:var(--mono,"Roboto Mono",monospace);font-size:10.5px;font-weight:700;color:var(--orange-d,#D94E00);letter-spacing:.02em;}',
      ...
      '.soho-net-card .snc-go{font-size:12px;font-weight:700;color:var(--orange,#FF5E00);margin-top:6px;}',
