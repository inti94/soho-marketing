...
window.SOHO_CALCS = [
    ...
    {cat:'매출',name:'필요 손님 수 계산기',desc:'고정비·변동비율·목표이익·객단가 → 목표이익 달성에 필요한 손님 수·좌석 회전율 계산',href:'target-customers-calc.html',icon:'Users',color:'#14B8A6',tags:['필요 손님 수','좌석 회전율','객단가'],views:0,isNew:true},
