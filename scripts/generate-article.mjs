...
<META>
{"slug":"영문-소문자-하이픈(기존과 중복금지)","searchEntry":{"url":"<슬러그>.html","title":"...","desc":"...","tag":"🏪 창업·세금 같은 형식","date":"${today}","rt":"8분","keywords":"쉼표구분 키워드"},"editorNote":"현장/상담 경험 기반 1~2문장 실무 코멘트(관점·의견 포함, 단순 요약 금지)","rssItem":"<item>\\n<title>...</title>\\n<link>https://sohotip.co.kr/<슬러그>.html</link>\\n<description>...</description>\\n<pubDate>RFC822 날짜</pubDate>\\n</item>"}
</META>
<HTML>
...
function normalize(html, meta) {
  ...
  return normalizeEmoji(injectAuthor(html, meta));
}
