...
## 각 h2 섹션은 이 5단계 흐름으로
1) 실제로 겪을 법한 상황(장면 묘사) → 2) 감정 공감("답답하시죠?", "억울하셨을 거예요") → 3) 왜 그런지 원인 설명(쉽게) → 4) 그래서 어떻게 하면 되는지 해결 → 5) 바로 써먹을 팁(💡 또는 ✅).
...
- 말풍선 1~2개: <div class="talk-bubble"><div class="tb-face">🧑‍🍳</div><div class="tb-body">…공감 한마디…</div></div>
