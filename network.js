...
(function () {
  ...
  function injectRecoStyle() {
    ...
    var css = [
      ...
      '#network-reco .nr-head::before{content:"";width:18px;height:2px;background:#FF5E00;display:inline-block;}',
      ...
      '#network-reco .nr-card:hover{border-color:#FF5E00;box-shadow:0 6px 18px rgba(255,94,0,.10);transform:translateY(-2px);}',
      ...
      '#network-reco .nr-go{font-size:12px;font-weight:600;color:#FF5E00;margin-top:2px;}',
